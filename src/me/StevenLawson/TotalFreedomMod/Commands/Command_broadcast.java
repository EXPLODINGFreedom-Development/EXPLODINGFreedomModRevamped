...
@CommandParameters(description = "Broadcasts the given message as the console, includes sender name.", usage = "/<command> <message>", aliases = "bcast,bc,ebc,ebcast")
public class Command_broadcast extends TFM_Command
{
    ...
    public boolean run(CommandSender sender, Player sender_p, Command cmd, String commandLabel, String[] args, boolean senderIsConsole)
    {
        ...
        TFM_Util.bcastMsg(String.format("§8[§CBroadcast§8]§b %s", message), ChatColor.AQUA);
