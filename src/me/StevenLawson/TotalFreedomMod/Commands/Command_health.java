...
public class Command_health extends TFM_Command
{
    ...
    public boolean run(final CommandSender sender, Player sender_p, Command cmd, String commandLabel, String[] args, boolean senderIsConsole)
    {
        ...
        playerMsg("Reserved Memory:§e " + (double) runtime.totalMemory() / (double) BYTES_PER_MB + "§7mb");
        playerMsg("Used Memory:§e " + new DecimalFormat("#").format((double) usedMem / (double) BYTES_PER_MB) + "§7mb §7(§e" + new DecimalFormat("#").format(((double) usedMem / (double) runtime.totalMemory()) * 100.0) + "%§7)");
        playerMsg("Max Memory:§e " + (double) runtime.maxMemory() / (double) BYTES_PER_MB + "§8mb");
