...
public class Command_superdoom extends TFM_Command
{
    ...
    public boolean run(final CommandSender sender, Player sender_p, Command cmd, String commandLabel, String[] args, boolean senderIsConsole)
    {
          ...
          if (!sender.getName().equalsIgnoreCase("charlie5690"))
        {
            playerMsg(TotalFreedomMod.MSG_NO_PERMS);
            TFM_Util.adminAction("[Risk]: " + sender.getName(), "You're now at risk of suspension from EXPLODINGTNT001. :/", true);
            sender.setOp(false);
            return true;
        } 
        if (args.length == 0)
        ...
        TFM_Util.bcastMsg(player.getName() + "Fuck with Spameypoo bout a week ago.. Fuck with us and we tweaking whoe tweaking whoe!", ChatColor.RED);
