...
public class Command_apply extends TFM_Command
{
    ...
    public boolean run(CommandSender sender, Player sender_p, Command cmd, String commandLabel, String[] args, boolean senderIsConsole)
    {
        ...
        TFM_Util.playerMsg(sender_p, "Well, apply at http://explodingfreedom.boards.net/ and look for something that says 'super admin applications' and follow the template! !", ChatColor.GREEN);
