...
public class TFM_Sync
{
     ...
     public static void seniorChatMessage(final CommandSender sender, final String message, final boolean isRed)
    {
      ...
      public static void executiveChatMessage(final CommandSender sender, final String message, final boolean isRed)
    {
        new BukkitRunnable()
        {
            ...
            public void run()
            {
                TFM_Util.executiveChatMessage(sender, message, isRed);
            }
