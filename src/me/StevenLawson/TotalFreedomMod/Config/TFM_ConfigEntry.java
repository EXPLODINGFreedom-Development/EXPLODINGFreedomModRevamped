...
public enum TFM_ConfigEntry
{
    ...
    ALLOW_CMDBLOCK_PLACE(Boolean.class, "allow.cmdblock_place"),
    ...
    //
    VOTELINKS_VOTELINK1(List.class, "votelinks.votelink1"),
    VOTELINKS_VOTELINK2(List.class, "votelinks.votelink2"),
    VOTELINKS_VOTELINK3(List.class, "votelinks.votelink3"),
    VOTELINKS_VOTELINK4(List.class, "votelinks.votelink4"),
    VOTELINKS_VOTELINK5(List.class, "votelinks.votelink5"),
    VOTELINKS_VOTELINK6(List.class, "votelinks.votelink6"),
    VOTELINKS_VOTELINK7(List.class, "votelinks.votelink7"),
    VOTELINKS_VOTELINK8(List.class, "votelinks.votelink8"),
